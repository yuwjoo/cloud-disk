 ...
 */
export type ApiPreCheckFileRequest = {
  name: string; // 文件名
  hash: string; // 文件hash
  size: number; // 文件大小
 ...
 */
export type ApiPreCheckFileResponse = CommonResponse<{
 ...
 */
export type ApiGetMultipartsRequest = {
  name: string; // 文件名
  hash: string; // 文件hash
 ...
 */
export type ApiGetMultipartsResponse = CommonResponse<
  {
    number: number; // 分片序号
    url: string; // 上传url
    expire: number; // 过期时间
 ...
 */
export type ApiMergeMultipartRequest = {
  name: string; // 文件名
  hash: string; // 文件hash
  uploadId: string; // 上传id
  parts: {
 ...
 */
export type ApiMergeMultipartResponse = CommonResponse;
