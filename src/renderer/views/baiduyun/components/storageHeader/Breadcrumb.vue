 ...
 * @FilePath: \cloud-disk\src\renderer\views\baiduyun\components\storageHeader\Breadcrumb.vue
 * @Author: YH
 * @Date: 2024-09-24 11:42:29
 * @LastEditors: YH
 * @LastEditTime: 2024-11-09 00:57:23
 * @Description: 
-->
<template>
...
const getPath = (pos: number) => {
  return dirList.value.slice(0, pos).join('/') || '/';
};
</script>
